...
<?php Ajouter_image($T_instruction['param1'], 'Unit&eacute; de distribution d&apos;eau', null, 'width:500px'); ?>
</div>
<div class="colonne">
<h2>Raccord rotatif</h2>
<?php Ajouter_image($T_instruction['param2'], 'raccord rotatif virtuel', null, 'width:300px'); ?>
</div>
...
<?php Ajouter_image($T_instruction['param3'], 'bride dans son contexte', null, 'width:900px'); ?>
