...
<?php $_SESSION['support']->Insérer_image($T_instruction['param1'], 'Unit&eacute; de distribution d&apos;eau', 'style=width:500px'); ?>
</div>
<div class="colonne">
<h2>Raccord rotatif</h2>
<?php $_SESSION['support']->Insérer_image($T_instruction['param2'], 'raccord rotatif virtuel', 'style=width:300px'); ?>
</div>
...
<?php $_SESSION['support']->Insérer_image($T_instruction['param3'], 'bride dans son contexte', 'style=width:900px class=image_centree'); ?>
