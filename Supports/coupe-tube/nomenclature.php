<?php // nomenclature du mini coupe-tube
Ligne_nomenclature(1, 1, 'Corps',											'','', 'corps');
Ligne_nomenclature(2, 1, 'Coulisseau',										'','', 'coulisseau');
Ligne_nomenclature(3, 2, 'Rouleau',											'','', 'rouleau');
Ligne_nomenclature(4, 2, 'Axe de rouleau',								'','', 'axe2rouleau');
