...
<?php Ajouter_image($T_instruction['param1'], 'vanne ouverte', 'style="width:300px" class="image_centree"'); ?>
</div>
...
<?php Ajouter_image($T_instruction['param2'], 'vanne ferm&eacute;e', 'style="width:300px" class="image_centree"'); ?>
</div>
