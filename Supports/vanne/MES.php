...
<p>Exemple d&apos;utilisation à l"atelier de maintenance : ouvrir ou fermer le circuit d&apos;air comprim&eacute;</p>
<?php Ajouter_image('MES_vanne.png', 'Vanne dans un circuit hydraulique', 'image_centree');