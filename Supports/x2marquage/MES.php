...
<?php
$SUPPORT->Insérer_image($T_instruction['param1'],'Pr&eacute;sentation','class=image_centree');
$SUPPORT->Insérer_image($T_instruction['param2'],'Douille marqu&eacute;e','class=image_centree');
