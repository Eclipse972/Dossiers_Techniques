...
<?php
$_SESSION->Image($T_instruction['param1'],'Pr&eacute;sentation','class=image_centree');
$_SESSION->Image($T_instruction['param2'],'Douille marqu&eacute;e','class=image_centree');
