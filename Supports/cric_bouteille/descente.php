<?php $_SESSION->Insérer_image($T_instruction['param1'], 'action pour la descente', 'style="height:400px; float: right;"'); ?>
<h1>Descente</h1>
...
<?php $_SESSION->Insérer_image($T_instruction['param2'], 'Circulation de l&apos;huile', 'class=image_centree style=width:400px');
