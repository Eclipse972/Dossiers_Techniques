<?php Ajouter_image('action_manuelle_descente', 'action pour la descente', null, 'height:400px; float: right;'); ?>
<h1>Descente</h1>
...
<?php Ajouter_image('decharge', 'Circulation de l&apos;huile', 'image_centree', 'width:400px');
