<?php Ajouter_image($T_instruction['param1'], 'action pour la descente', null, 'height:400px; float: right;'); ?>
<h1>Descente</h1>
...
<?php Ajouter_image($T_instruction['param2'], 'Circulation de l&apos;huile', 'image_centree', 'width:400px');
