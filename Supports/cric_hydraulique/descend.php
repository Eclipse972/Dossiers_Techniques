...
<?php $_SESSION->Image($T_instruction['param1'], 'vis de d&eacute;scente', 'style="height :150px; vertical-align: middle;"'); ?>
</li>
...
<?php  $_SESSION->Image($T_instruction['param2'], 'Ouvrir vis de d&eacute;scente', 'style="height :150px; vertical-align: middle;"'); ?>
</li>
