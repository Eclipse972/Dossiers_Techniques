...
<?php echo '<img src="'.$_SESSION[DOSSIER].'images/vis2descente.png" style=" height:150px; vertical-align: middle;" alt="vis de d&eacute;scente">'; ?>
</li>
...
<?php echo '<img src="'.$_SESSION[DOSSIER].'images/ouvrir_vis2descente.png" style="height:150px; vertical-align: middle;" alt="Ouvrir vis de d&eacute;scente">'; ?>
</li>
