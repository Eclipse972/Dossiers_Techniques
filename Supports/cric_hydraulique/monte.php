...
<?php
	$_SESSION['support']->Insérer_image($T_instruction['param1'], 'vis de d&eacute;scente', 'style=height:180px');
	$_SESSION['support']->Insérer_image($T_instruction['param2'], 'Fermer vis de d&eacute;scente', 'style=height:180px');
?>
</li>
<li>Positionner le cric sous le châssis du v&eacute;hicule en plaçant la sellette sous le bas de caisse.</li>
<li><?php $_SESSION['support']->Insérer_image($T_instruction['param3'], 'pomper pour lever le v&eacute;hicule', 'style=height:180px;float:right;'); ?>
