...
SELECT
	...
	beta,
	gamma,
	(SELECT URL FROM Vue_URLvalides WHERE niveau1 = alpha AND niveau2 = beta AND niveau3 = gamma AND methodeHttp = 'GET') AS URL,
	imageMenu AS image,
	texteMenu AS texte,
	CONCAT(
		'<a href="',(SELECT URL FROM Vue_URLvalides WHERE niveau1 = alpha AND niveau2 = beta AND niveau3 = gamma AND methodeHttp = 'GET'),'">',
