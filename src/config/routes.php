...
$app->group('/bride-a-nez', function($group) {
    ...
    $group->get('/SE/corps-bride',                 [BrideAnezControleur::class, 'SEcorpsBride']);
    $group->get('/SE/nez-bride',                   [BrideAnezControleur::class, 'SEnezBride']);
    $group->get('/SE/ensemble-piston',             [BrideAnezControleur::class, 'SEensemblePiston']);
    $group->get('/SE/plaquette',                   [BrideAnezControleur::class, 'SEplaquette']);
    $group->get('/SE/ressort',                     [BrideAnezControleur::class, 'SEressort']);
