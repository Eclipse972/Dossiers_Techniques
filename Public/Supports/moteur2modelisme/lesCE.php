...
<img src="<?=$_SESSION['support']->Dossier().'images/'?>CE1-bati.png" alt ="CE1: le b&acirc;ti">
</div>

<div class="colonne">
<p>CE2: le vilebrequin</p>
<img src="<?=$_SESSION['support']->Dossier().'images/'?>CE2-vilebrequin.png" width=305px alt ="CE2: le vilebrequin">
</div>

<div class="colonne">
<p>CE3: la bielle</p>
<img src="<?=$_SESSION['support']->Dossier().'images/'?>CE3-bielle.png" width=91px alt ="CE3: la bielle">
</div>

<div class="colonne">
<p>CE4: le piston</p>
<img src="<?=$_SESSION['support']->Dossier().'images/'?>CE4-piston.png" width=131px alt ="CE4: le piston">
</div>

<h2>Les roulements à billes du moteur</h2>
<img src="<?=$_SESSION['support']->Dossier().'images/'?>grand_roulement.png" width=200px alt ="grand roulement">
<img src="<?=$_SESSION['support']->Dossier().'images/'?>petit_roulement.png" width=160px alt ="petit roulement">
