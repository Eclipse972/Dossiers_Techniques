...
if (in_array($type_page, $T_pages_autorisées))
	...
	$Thydrate = array('script' => 'XX'); // cette valeur doit être un nom de fichier qui n'existe pas et composé de deux lettres pour provoquer l'affichage Désolé, il semblerai...
}
